...
multiple independent fronts in parallel. For a 2D problem with $N=n^2$ unknowns, 
...
Iterative methods are an alternative approach that have a small memory requirement. 
They require preconditioning due to the Helmholtz system's indefiniteness. 
